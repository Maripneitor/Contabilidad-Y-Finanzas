...
export const seedData = (req, res) => {
    try {
        const seed = [
            ...
            { id: 2, date: "2026-01-28", description: "Compra de mercancía al contado", entries: [
                { account: 'AC-IN', debe: 20000, haber: 0 }, { account: 'AC-IV', debe: 3000, haber: 0 },
                { account: 'AC-BA', debe: 0, haber: 23000 }
            ]},
            { id: 3, date: "2026-01-31", description: "Compra mixta de mercancía (20% contado)", entries: [
            ...
            { id: 4, date: "2026-02-04", description: "Compra mercancía 100% crédito", entries: [
                { account: 'AC-IN', debe: 10000, haber: 0 }, { account: 'AC-IP', debe: 1600, haber: 0 },
                { account: 'PC-PR', debe: 0, haber: 11600 }
            ]},
            { id: 5, date: "2026-02-06", description: "Anticipo de Clientes (Ingreso Bancos)", entries: [
                { account: 'AC-BA', debe: 2320, haber: 0 }, { account: 'PC-AC', debe: 0, haber: 2000 },
                { account: 'PC-IT', debe: 0, haber: 320 }
            ]},
            { id: 6, date: "2026-02-10", description: "Pago 1 mes de renta anticipada", entries: [
                { account: 'AD-RA', debe: 5000, haber: 0 }, { account: 'AC-IV', debe: 800, haber: 0 },
                { account: 'AC-BA', debe: 0, haber: 5800 }
            ]},
            { id: 7, date: "2026-02-12", description: "Compra de papelería al contado", entries: [
                { account: 'AD-PU', debe: 1000, haber: 0 }, { account: 'AC-IV', debe: 160, haber: 0 },
                { account: 'AC-BA', debe: 0, haber: 1160 }
            ]},
            { id: 8, date: "2026-03-04", description: "Venta total consolidada con aplicación de anticipo", entries: [
