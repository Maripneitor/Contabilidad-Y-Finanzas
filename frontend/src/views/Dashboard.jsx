...
const MetricCard = ({ label, value, icon, color, trend }) => (
    <div className="bento-card relative overflow-hidden bg-surface-container-lowest dark:bg-slate-900 p-6 rounded-[2rem] shadow-sm border border-surface-container transition-all hover:scale-[1.02] flex flex-col justify-between h-[180px]">
    ...
    return (
        <div className="space-y-12 animate-in fade-in duration-700">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div className="flex gap-4">
                    ...
                    <button 
                        ...
                        className="bg-surface-container dark:bg-slate-800 text-on-surface px-6 py-3 rounded-2xl font-bold font-headline shadow-sm hover:bg-surface-container-high transition-all active:scale-95 flex items-center gap-2"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 items-stretch">
                {/* Main Insight */}
                <div className="lg:col-span-8 bento-card bg-primary dark:bg-slate-800 rounded-[3rem] p-10 text-white flex flex-col justify-between shadow-2xl shadow-primary/10 relative overflow-hidden h-[420px]">
                ...
                <div className="lg:col-span-6 bento-card bg-surface-container-high dark:bg-slate-800/50 p-10 rounded-[3rem] shadow-sm border border-surface-container flex flex-col justify-center gap-6 h-[220px]">
                    <div className="flex items-center gap-6">
                        <div className="w-16 h-16 bg-on-background dark:bg-slate-900 rounded-full flex items-center justify-center text-white">
